...
] {.column width="50%"}<img src="figures/industrious_rev.jpg" width="300">]
...
::: {.columns}
::: {.column width="50%"}![:scale 90%](figures/nassau_senior.jpg)]

] {.column width="50%"}![:scale 90%](figures/chadwick.png)]
]
...
::: {.center}**Clearly definitions matter!**]
