...
+ I will spend most time in the lecture tackling point 2 by going over some more technical additional readings
...
::: {.columns}
::: {.column width="50%"}
### British foreign lending

> "Never before or since has one nation committed so much of its national income and savings to capital formation abroad." <br> &mdash;Edelstein, p. 191

::: {.column width="50%"}
```{r foreigninvestment, fig.retina=4, fig.height=4, fig.width=6}
library(scales)

invdat <- read_csv("data/edelstein-table8.1.csv")

invdat |> 
  ggplot(aes(Period, `NFI/GNP`/100, 
             label=paste0(`NFI/GNP`, "%"))) +
  geom_point() +
  geom_line() +
  ggrepel::geom_text_repel() +
  theme_lecture +
  scale_y_continuous(labels = percent) +
  ggtitle("Net foreign investment as a share of GNP") +
  ylab("Net Foreign Investment/GNP")

```

+ Investment abroad is large
+ Investment abroad is cyclical
+ Why so different from the present?
  - Free-standing company structure perhaps (Wilkins 1988)?
:::
...
### What explains the rise in foreign lending?
...
+ Domestic opportunities less profitable
+ Insufficient domestic consumption
  - Hobson thesis
  - Edelstein finds some support
  - Multiple mechanisms including aging population
...
+ Higher profits abroad
  - Big social infrastructure to build (railways in particular)
  - We turn to this question in more detail below
 {.large}

#### Sources of disagreement

+ Did returns rise abroad or fall domestically?
+ Were returns higher abroad?
+ If returns domestically were lower, might they have been higher with more investment?
:::


---

### Is it true that "...too much was invested abroad because of imperfect capital markets..." (McCloskey 1970)?

>  "By reallocating resources, of course, any one sector of the economy could have grown faster: industry could have grown at the expense of services and exports at the expense of production for home consumption had labour and capital been allocated differently. The most popular target for hypothetical reallocation has been Britain's enormous holdings of capital abroad in the late nineteenth century." <br> -McCloskey, p. 451.

### What were the *consequences* of the large-scale export of capital domestically? Two positions:

::: {.large}
1. It was good because it maximized British income
2. It was bad because it under-invested in British industry resulting in long-term economic decline
:::
...
### Some basic financial intuition
...
risks**" <br> &mdash;(Malkiel 2003, p. 60 emphasis added).

+ Not enough to look at return, need to look at how risky it is (often measured as standard deviation of return)

### Diversification

+ Imagine betting 100 on a single coin flip:
  - Heads you win 300, Tails you lose 100
  - Expected gains: 100
+ Now imagine betting 10 on 10 separate coin flips
  - Each flip, Heads you win 30 Tails you lose 10
  - Expected gains for all ten flips: 100
...
---
.center[
![:scale 90%:::(figures/read_prices.png)
:::
