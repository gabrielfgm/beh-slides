...
knitr::include_graphics(c("figures/arthur_young.jpg", "figures/jethro_tull.jpg"))
```
...
knitr::include_graphics(c("figures/allen_first_ar.png",
                          "figures/allen_second_ar.png"))
```
