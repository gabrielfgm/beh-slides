...
---
 {.column width="50%"}
![tax_graph:::(figures/tax_brewer.png) {.columns}
::: {.column width="50%"}
### Tax Power
...
+ Growing body of evidence pushing Financial Revolution back in time
    - e.g. Ann Murphy, *Origins of English Financial Markets*, Sussman (2019) on Corporation of London
...
![:scale 80%:::(figures/clark_return_rent.png)
...
> "Arguably, what was crucial was not the security of property (save in the sense of the importance of a commitment to contract, due process and the rule of law) but the existence of effective avenues to allow it to be alienated, to be used by those who would employ it more efficiently." Do you agre with this claim by Hoppit?
