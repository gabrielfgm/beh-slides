...
> rates of other currencies — particularly in Latin America —
> fluctuated widely, and depreciated enormously, over the period. This
> contrast between the 'core' countries and those of the 'periphery'
> can be largely explained by the cyclical pattern of capital movements
> and terms of trade, which contributed to stability in the first group,
> and to instability in the second."
>
...
-   **Why?** And why then? Flandreau's essay "The French Crime of 1873"
    investigates the collapse of bimetallism in France and its global
    consequences.

## The French Crime of 1873 {.smaller}

Flandreau frames the question by contrasting the gold standard's
'golden age' (1880–1914) with its 'gloomy age' (1920s–30s):
...
Why did silver lose out? Flandreau identifies four schools of thought:
...
-   But switching from silver to gold was costly: you needed to acquire
    gold and dispose of demonetized silver at acceptable prices.

-   Until the late 1860s these costs *deterred* countries from acting.

## How bimetallism stabilized the system {.smaller}
...
-   Result: between 1850 and 1870, the gold-silver exchange rate was
    held within a narrow band reflecting only the costs of melting and
    re-minting.

-   France's monetary holdings adjusted **endogenously** — becoming more
    intensive in whichever metal was relatively more abundant — buffering
    global bullion shocks.
:::

## The gold-silver price ratio, 1800–1900

![](images/flandreau-gold-silver-ratio.png)

-   Ratio held close to **15.5 silver per gold** from 1800 to 1873
-   After 1873: sharp rise, peaking around **35** by 1896 — silver
    collapses in value
-   The stability was not natural — it was the French bimetallic
    system at work
...
## Conclusion: failure of cooperation, 1873 {.smaller}

Flandreau's reframing has important implications for how we understand
the 'golden age' of the gold standard:

-   The classical gold standard (1880–1914) is often praised for
    international cooperation — but the *conditions* that made it
    possible were established through conflict and accident.

-   The dysfunctions of the interwar period (competitive gold
    attraction, beggar-thy-neighbour policies, Franco-German rivalry)
    were **not new** — they were present from the start.

-   The stability of 1880–1914 reflected a particular — and fragile —
    political and economic configuration, not a robust cooperative
    equilibrium.
...
-   Under the international gold standard central banks worked to make
    ...
    standard currencies [@flandreau2004].
...
-   Flandreau argues the gold standard was an 'accident of history'.
    Does this change how we should interpret the stability of 1880–1914?
