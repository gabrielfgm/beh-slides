...
::: {.large}
+ Domestic economy as a cause of the war
+ The global economy as a cause of the war
+ Economic constraints on the *conduct* of the war
:::
...
::: {.column width="50%"}
#### Global Growth & balance of power

+ Fertik & Tooze/O'Rourke suggest growth could be de-stabilizing of geopolitical balance

#### Economics *precludes* war

+ Bloch/Angel argue that global economic system would be so disrupted by war that war **cannot** have an economic explanation
...
.pull-left60[
### Inequality, Colonies and War

> "...the economic causes of war, namely the pressure of population and the competitive struggle for markets. It is the second factor, which probably played a predominant part in the nineteenth century, and might again." <br>&mdash;Keynes quoted in Milanovic (2016), p. 95

+ Milanovic argues for the causal channel
  1. Domestic inequality leads to
  2. Search for profit abroad leads to
  3. Imperial rivalry leads to
  4. War!
+ Argument is old marxist argument: Marx/Hobson/Luxemburg/Lenin
+ See also Hauner, Milanovic & Naidu, "Inequality, Foreign Investment, and Imperialism Prior to World War I"

:::

.pull-right40[
.center[
![:scale 70%:::(figures/milanovic-frontis.jpg)
:::

+ The argument is **internalist**
  - War arises from internal characteristics of the countries
:::
...
### Economics and domestic vs systemic accounts of war
::: {.large}

### Domestic explanations

+ War arises because of **internal characteristics of states**
  - E.g. "this state is war-like because it is autocratic"
  - Generally unpopular position in international relations
  
### Systemic explanations

+ War arises because of **properties of the system in which states are embedded**

The economic convergence thesis is **clearly systemic** and Milanovic is explicit that his account is **domestic**. Offer is somewhere in between: characteristics of domestic economy lead to arms race. Arms race is systemic.
:::
...
+ How did the structure of the British economy influence war planning and conduct?
:::


---

### Britain's economy and the conduct of the war

.pull-left60[
::: {.large}
+ Offer is linking the first world war to "the emergence of a global agrarian economy on which Europe depended for food" (Martin 2021)
  - Conditions decisions to pursue naval arms race
+ Also affects **how the war is fought**
  - Gallipoli campaign is aimed at accessing Russian wheat


.pull-right40.center[
![:scale 70%:::(figures/lambert-frontis.jpeg)
:::
...
**Because of the strike I will lecture on these themes together next week**
:::